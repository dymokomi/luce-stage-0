...
ProjectionEntry::ProjectionEntry(const TexelId& texel, const char* output,
                                 ValueType type, const char* filename)
    : texel_id(texel),
      output_name(output != 0 ? output : ""),
      value_type(type),
