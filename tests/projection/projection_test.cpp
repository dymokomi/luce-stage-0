...
static void test_projection() {
  ...
  if (true) {
    ...
    CHECK(manifest.put(ProjectionEntry(text_id, "text", VALUE_TEXT, "notes/message.txt")));
    CHECK(manifest.put(ProjectionEntry(blob_id, "blob", VALUE_BLOB, "assets/data.bin")));
    CHECK(!manifest.put(ProjectionEntry(blob_id, "other", VALUE_BLOB, "assets/data.bin")));
    CHECK(!manifest.put(ProjectionEntry(text_id, "text", VALUE_TEXT, "notes/other.txt")));
