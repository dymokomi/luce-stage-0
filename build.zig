...
pub fn build(b: *std.Build) void {
    ...
    const sanitizer_filters = &.{
        ...
        "interpreter worker rejects malformed",
        "file open rejects the post-close",
        "host byte counts are bounded",
        "file callbacks reject unknown answers",
        "C scalar lengths counts and tags",
        "C byte pointers reject null",
        "C Value output pointers reject null",
        "C status output pointers reject null",
        "C borrowed Value and array pointers reject null",
        "C callbacks fail closed",
        "blocked workers join while",
        "worker channel exhaustion",
