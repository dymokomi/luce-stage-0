...
own affair. `extern var name: T` binds a C global the same way — direct
loads and stores of the symbol, C owning the value. `luce build --link`
is how the foreign code joins the artifact.
