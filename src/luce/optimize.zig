...
const prune_pass = @import("optimize/prune.zig");

pub const prune = prune_pass.prune;
pub const dead = @import("optimize/dead.zig").dead;

pub const effects = @import("optimize/effects.zig");
...
test {
    _ = @import("optimize/dead.zig");
    _ = @import("optimize/effects.zig");
    _ = @import("optimize/prune.zig");
    _ = @import("optimize/registers.zig");
    _ = @import("optimize/test.zig");
}
