...
pub const ConstantValue = @import("06_mir/defs.zig").ConstantValue;
pub const ContainerConstant = @import("06_mir/defs.zig").ContainerConstant;
...
pub const mapKeyStorage = @import("06_mir/defs.zig").mapKeyStorage;
