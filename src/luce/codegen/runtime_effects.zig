...
pub const Service = enum {
    ...
    luce_rt_channel_new,
    luce_rt_channel_send,
    luce_rt_channel_receive,
    luce_rt_channel_close,
    luce_rt_channel_len,
    luce_rt_channel_cap,
...
pub fn describe(service: Service) Effect {
    return switch (service) {
        ...
        .luce_rt_channel_send => .{
            .memory = touches_heap,
            .parameters = &.{ .run, .value_in, .value_in, .plain, .unknown, .plain, .plain },
            .willreturn = false,
        },
        .luce_rt_channel_receive => .{
            .memory = touches_heap,
            .parameters = &.{ .run, .value_in, .plain, .plain, .value_out, .unknown, .plain, .plain },
            .willreturn = false,
        },
        .luce_rt_channel_close => .{
            .memory = touches_heap,
        ...
        .luce_rt_channel_len => .{
            .memory = touches_heap,
            .parameters = &.{ .run, .value_in, .unknown },
            .willreturn = false,
        },
        .luce_rt_channel_cap => .{
            .memory = touches_heap,
