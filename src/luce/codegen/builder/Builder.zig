...
const std = @import("std"); // LUCE: was @import("../../std.zig") in-tree at std
const Io = std.Io;
...
pub const AddrSpace = enum(u24) {
    ...
    // See codegen/lib/Target/X86/X86.h
    ...
    // See codegen/lib/Target/AVR/AVR.h
    ...
    // See codegen/lib/Target/NVPTX/NVPTX.h
    ...
    // See codegen/lib/Target/AMDGPU/AMDGPU.h
    ...
    // See codegen/include/codegen/CodeGen/WasmAddressSpaces.h
...
pub const WipFunction = struct {
    ...
    // vendored copy exists for (codegen/builder.zig has the warrant).
