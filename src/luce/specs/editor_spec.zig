...
const editor_files = [_]agree.File{
    ...
    .{ .name = "syntax.definition", .source = @embedFile("syntax/definition.luc"), .path = "syntax/definition.luc" },
    .{ .name = "syntax.registry", .source = @embedFile("syntax/registry.luc"), .path = "syntax/registry.luc" },
    .{ .name = "syntax.luce", .source = @embedFile("syntax/luce.luc"), .path = "syntax/luce.luc" },
    .{ .name = "syntax.c", .source = @embedFile("syntax/c.luc"), .path = "syntax/c.luc" },
    .{ .name = "syntax.python", .source = @embedFile("syntax/python.luc"), .path = "syntax/python.luc" },
    .{ .name = "syntax.swift", .source = @embedFile("syntax/swift.luc"), .path = "syntax/swift.luc" },
    .{ .name = "syntax.go", .source = @embedFile("syntax/go.luc"), .path = "syntax/go.luc" },
