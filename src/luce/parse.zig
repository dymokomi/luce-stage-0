...
pub const Error = @import("parse/grammar.zig").Error;
pub const Parser = @import("parse/grammar.zig").Parser;
pub const parse = @import("parse/grammar.zig").parse;

/// A human name for a token kind, and the word behind a keyword kind:
/// the vocabulary parse diagnostics are written in.
pub const describe = @import("parse/grammar.zig").describe;
pub const keywordWord = @import("parse/grammar.zig").keywordWord;
