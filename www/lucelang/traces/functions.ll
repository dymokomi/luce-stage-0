; ModuleID = '/Users/sedov/Dev/luciaos/www/lucelang/examples/functions.luc'
source_filename = "/Users/sedov/Dev/luciaos/www/lucelang/examples/functions.luc"
...
@luce.text.3 = private unnamed_addr constant [21 x i8] c"null object reference"
@luce.text.4 = private unnamed_addr constant [22 x i8] c"object used after free"
@luce.text.5 = private unnamed_addr constant [24 x i8] c"host service unavailable"
@luce.text.6 = private unnamed_addr constant [9 x i8] c"factorial"
@luce.text.7 = private unnamed_addr constant [60 x i8] c"/Users/sedov/Dev/luciaos/www/lucelang/examples/functions.luc"
@luce.origins.0 = private constant [13 x { i32, i32 }] [{ i32, i32 } { i32 2, i32 5 }, { i32, i32 } { i32 2, i32 5 }, { i32, i32 } { i32 2, i32 5 }, { i32, i32 } { i32 2, i32 5 }, { i32, i32 } { i32 3, i32 9 }, { i32, i32 } { i32 3, i32 9 }, { i32, i32 } { i32 4, i32 5 }, { i32, i32 } { i32 4, i32 5 }, { i32, i32 } { i32 4, i32 5 }, { i32, i32 } { i32 4, i32 5 }, { i32, i32 } { i32 4, i32 5 }, { i32, i32 } { i32 4, i32 5 }, { i32, i32 } { i32 4, i32 5 }]
@luce.text.8 = private unnamed_addr constant [4 x i8] c"main"
@luce.origins.1 = private constant [12 x { i32, i32 }] [{ i32, i32 } { i32 7, i32 5 }, { i32, i32 } { i32 7, i32 5 }, { i32, i32 } { i32 7, i32 5 }, { i32, i32 } { i32 7, i32 5 }, { i32, i32 } { i32 7, i32 5 }, { i32, i32 } { i32 7, i32 5 }, { i32, i32 } { i32 7, i32 5 }, { i32, i32 } { i32 7, i32 5 }, { i32, i32 } { i32 7, i32 5 }, { i32, i32 } { i32 7, i32 5 }, { i32, i32 } { i32 7, i32 5 }, { i32, i32 } { i32 7, i32 5 }]
@luce.functions = private constant [2 x { ptr, i64, ptr, i64, ptr, i64 }] [{ ptr, i64, ptr, i64, ptr, i64 } { ptr @luce.text.6, i64 9, ptr @luce.text.7, i64 60, ptr @luce.origins.0, i64 13 }, { ptr, i64, ptr, i64, ptr, i64 } { ptr @luce.text.8, i64 4, ptr @luce.text.7, i64 60, ptr @luce.origins.1, i64 12 }]
...
define internal i32 @luce.0.factorial(ptr align 8 nocapture readonly nonnull dereferenceable(472) noundef %0, ptr align 8 nocapture nonnull noundef %1, i64 noundef %2, i64 %3, ptr align 8 nocapture nonnull dereferenceable(8) writeonly noundef %4) {
5:
...
22:
  %23 = icmp slt i64 %7, 1
  br i1 %23, label %24, label %27, !prof !0

24:
  %25 = extractvalue { ptr, i64 } { ptr @luce.text.1, i64 19 }, 0
  %26 = extractvalue { ptr, i64 } { ptr @luce.text.1, i64 19 }, 1
  call void @luce_rt_raise(ptr %1, i32 6, ptr %25, i64 %26)
  call void @luce_rt_unwound(ptr %1, i32 0, i32 10)
  ret i32 1

27:
  %28 = call i32 @luce.0.factorial(ptr %0, ptr %1, i64 %7, i64 %17, ptr %8)
  %29 = icmp ne i32 %28, 0
  br i1 %29, label %30, label %31, !prof !0
...
31:
  ...
  %33 = call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %14, i64 %32)
  %34 = extractvalue { i64, i1 } %33, 0
  %35 = extractvalue { i64, i1 } %33, 1
  br i1 %35, label %36, label %39, !prof !0

36:
  %37 = extractvalue { ptr, i64 } { ptr @luce.text.0, i64 16 }, 0
  %38 = extractvalue { ptr, i64 } { ptr @luce.text.0, i64 16 }, 1
  call void @luce_rt_raise(ptr %1, i32 0, ptr %37, i64 %38)
...
4:
  ...
  %9 = extractvalue { ptr, i64 } { ptr @luce.text.2, i64 0 }, 0
  %10 = ptrtoint ptr %9 to i64
  %11 = getelementptr inbounds { i8, i8, [6 x i8], i64, i64 }, ptr %6, i32 0, i32 3
  store i64 %10, ptr %11, align 8
  %12 = extractvalue { ptr, i64 } { ptr @luce.text.2, i64 0 }, 1
...
27:
  %28 = extractvalue { ptr, i64 } { ptr @luce.text.3, i64 21 }, 0
  %29 = extractvalue { ptr, i64 } { ptr @luce.text.3, i64 21 }, 1
...
39:
  %40 = extractvalue { ptr, i64 } { ptr @luce.text.4, i64 22 }, 0
  %41 = extractvalue { ptr, i64 } { ptr @luce.text.4, i64 22 }, 1
...
45:
  %46 = extractvalue { ptr, i64 } { ptr @luce.text.4, i64 22 }, 0
  %47 = extractvalue { ptr, i64 } { ptr @luce.text.4, i64 22 }, 1
...
60:
  %61 = extractvalue { ptr, i64 } { ptr @luce.text.1, i64 19 }, 0
  %62 = extractvalue { ptr, i64 } { ptr @luce.text.1, i64 19 }, 1
  call void @luce_rt_raise(ptr %1, i32 6, ptr %61, i64 %62)
  call void @luce_rt_unwound(ptr %1, i32 1, i32 4)
  ret i32 1

63:
  %64 = call i32 @luce.0.factorial(ptr %0, ptr %1, i64 %14, i64 %53, ptr %15)
  %65 = icmp ne i32 %64, 0
...
declare { i64, i1 } @llvm.ssub.with.overflow.i64(i64 %0, i64 %1) #0
