; ModuleID = '/Users/sedov/Dev/luciaos/www/lucelang/examples/modules.luc'
source_filename = "/Users/sedov/Dev/luciaos/www/lucelang/examples/modules.luc"
...
@luce.text.7 = private unnamed_addr constant [58 x i8] c"/Users/sedov/Dev/luciaos/www/lucelang/examples/modules.luc"
@luce.origins.0 = private constant [10 x { i32, i32 }] [{ i32, i32 } { i32 4, i32 5 }, { i32, i32 } { i32 4, i32 5 }, { i32, i32 } { i32 4, i32 5 }, { i32, i32 } { i32 4, i32 5 }, { i32, i32 } { i32 4, i32 5 }, { i32, i32 } { i32 4, i32 5 }, { i32, i32 } { i32 4, i32 5 }, { i32, i32 } { i32 4, i32 5 }, { i32, i32 } { i32 4, i32 5 }, { i32, i32 } { i32 4, i32 5 }]
@luce.text.8 = private unnamed_addr constant [16 x i8] c"trace_math.twice"
@luce.text.9 = private unnamed_addr constant [61 x i8] c"/Users/sedov/Dev/luciaos/www/lucelang/examples/trace_math.luc"
@luce.origins.1 = private constant [4 x { i32, i32 }] [{ i32, i32 } { i32 2, i32 5 }, { i32, i32 } { i32 2, i32 5 }, { i32, i32 } { i32 2, i32 5 }, { i32, i32 } { i32 2, i32 5 }]
@luce.functions = private constant [2 x { ptr, i64, ptr, i64, ptr, i64 }] [{ ptr, i64, ptr, i64, ptr, i64 } { ptr @luce.text.6, i64 4, ptr @luce.text.7, i64 58, ptr @luce.origins.0, i64 10 }, { ptr, i64, ptr, i64, ptr, i64 } { ptr @luce.text.8, i64 16, ptr @luce.text.9, i64 61, ptr @luce.origins.1, i64 4 }]
...
4:
  ...
  %9 = extractvalue { ptr, i64 } { ptr @luce.text.0, i64 0 }, 0
  %10 = ptrtoint ptr %9 to i64
  %11 = getelementptr inbounds { i8, i8, [6 x i8], i64, i64 }, ptr %6, i32 0, i32 3
  store i64 %10, ptr %11, align 8
  %12 = extractvalue { ptr, i64 } { ptr @luce.text.0, i64 0 }, 1
...
53:
  %54 = extractvalue { ptr, i64 } { ptr @luce.text.3, i64 19 }, 0
  %55 = extractvalue { ptr, i64 } { ptr @luce.text.3, i64 19 }, 1
  call void @luce_rt_raise(ptr %1, i32 6, ptr %54, i64 %55)
  call void @luce_rt_unwound(ptr %1, i32 0, i32 2)
  ret i32 1

56:
  %57 = call i32 @luce.1.trace_math.twice(ptr %0, ptr %1, i64 %14, i64 %50, ptr %15)
  %58 = icmp ne i32 %57, 0
...
define internal i32 @luce.1.trace_math.twice(ptr align 8 nocapture readonly nonnull dereferenceable(472) noundef %0, ptr align 8 nocapture nonnull noundef %1, i64 noundef %2, i64 %3, ptr align 8 nocapture nonnull dereferenceable(8) writeonly noundef %4) {
5:
...
7:
  ...
  br i1 %11, label %12, label %15, !prof !0

12:
  %13 = extractvalue { ptr, i64 } { ptr @luce.text.5, i64 16 }, 0
  %14 = extractvalue { ptr, i64 } { ptr @luce.text.5, i64 16 }, 1
  call void @luce_rt_raise(ptr %1, i32 0, ptr %13, i64 %14)
...
declare void @luce_rt_exhaust(ptr nocapture nonnull noundef %0) #3

; Function Attrs: nounwind willreturn memory(argmem: readwrite, inaccessiblemem: readwrite)
declare void @luce_rt_drop_storage(ptr nocapture nonnull noundef %0, ptr align 8 nocapture readonly nonnull dereferenceable(24) noundef %1, ptr align 8 nocapture nonnull dereferenceable(24) writeonly noundef %2) #4

; Function Attrs: nounwind speculatable willreturn nofree nosync nocallback memory(none)
declare { i64, i1 } @llvm.smul.with.overflow.i64(i64 %0, i64 %1) #5
...
attributes #3 = { nounwind cold willreturn memory(argmem: write) }
attributes #4 = { nounwind willreturn memory(argmem: readwrite, inaccessiblemem: readwrite) }
attributes #5 = { nounwind speculatable willreturn nofree nosync nocallback memory(none) }
