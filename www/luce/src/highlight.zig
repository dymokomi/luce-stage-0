...
pub const keywords = [_][]const u8{
    "func", "struct", "enum",   "union",  "match",    "const",
    "let",  "var",    "if",     "elif",   "else",     "while",
    "for",  "in",     "return", "break",  "continue", "and",
    "or",   "not",    "true",   "false",  "import",   "none",
    "try",  "catch",  "self",   "static", "public",   "private",
};
