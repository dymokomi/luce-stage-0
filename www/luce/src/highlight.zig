...
pub const keywords = [_][]const u8{
    "func",     "struct", "class", "init",  "deinit", "interface", "alias",
    "enum",     "union",  "match", "const", "let",    "var",       "if",
    "elif",     "else",   "while", "for",   "in",     "return",    "break",
    "continue", "and",    "or",    "not",   "is",     "true",      "false",
    "import",   "none",   "try",   "catch", "self",   "static",    "public",
    "private",  "weak",
};
