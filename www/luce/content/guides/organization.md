# Organize a project and make a package
...
private. The [visibility chapter](/learn/visibility/) explains the language
...
introduction to imports and project roots, start with [Modules](/learn/modules/).
