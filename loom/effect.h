...
public:
  ...
  virtual bool perform(const EffectIntent& intent,
                       EffectObservation* observation) = 0;
};
...
private:
  EffectBoundaryResult error(EffectBoundaryCode code,
