...
#include "fabric/value_outcome.h"
...
public:
  ...
  bool demand(const TexelId& texel, const char* output,
...
private:
  ...
  DemandResult demand_source(const Texel& texel, const OutputPort& output,
                             U64 generation);
  DemandResult demand_computed(const Texel& texel, const String& output,
                               U64 generation);
  DemandResult evaluate(const Texel& texel, const String& output,
                        U64 generation, const ValueOutcomeMap& inputs,
                        const RevisionList& revisions);
  DemandResult cache_error(const Texel& texel, const String& output,
